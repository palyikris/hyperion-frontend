...
export const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row relative bg-hyperion-cream overflow-hidden">
      ...
      <div className="hidden md:flex md:w-4/7 xl:w-3/5 relative overflow-hidden bg-linear-to-b from-hyperion-deep-sea to-hyperion-deep-sea">
        {/* Loader overlay */}
        {isImgLoading && (
          ...
          <div className="w-full flex justify-center items-center flex-col text-center">
            <div className="relative flex flex-col items-center">
              ...
              <Title
                ...
                size="5xl"
                className="text-2xl sm:text-4xl md:text-5xl tracking-[0.14em] sm:tracking-[0.24em]"
              ></Title>
            </div>
            <img
              src="/logo.png"
